...
```{r, fig.cap="SCpubr do_GroupwiseDEPlot default output.", fig.width=12, fig.height=12}
# Default output.
...
```{r, fig.cap="SCpubr do_GroupwiseDEPlot increasing the number of DE genes by cluster.", fig.width=12, fig.height=12}
...
```{r, fig.cap="SCpubr do_GroupwiseDEPlot with modified row and column titles.", fig.width=12, fig.height=12}
...
```{r, fig.cap="SCpubr do_GroupwiseDEPlot with multiple layers of mean expression.", fig.width=12, fig.height=12}
...
```{r, fig.cap="SCpubr do_GroupwiseDEPlot with other viridis scales.", fig.width=12, fig.height=12}
