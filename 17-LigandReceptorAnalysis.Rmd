...
```{r, fig.cap = "SCpubr do_LigandReceptorPlot default output.", fig.width=16, fig.height=10}
...
```{r, fig.cap = "SCpubr do_LigandReceptorPlot default output with extra interactions.", fig.width=25, fig.height=50}
...
```{r, fig.cap = "SCpubr do_LigandReceptorPlot output Chord diagram with the total significant interactions between the clusters.", fig.width=16, fig.height=16}
...
```{r, fig.cap = "SCpubr do_LigandReceptorPlot output Chord diagram with the total ligand-receptor interactions from each cluster and all the rest.", fig.width=16, fig.height=16}
...
```{r, fig.cap = "SCpubr do_LigandReceptorPlot output Chord diagram with the total significant interactions between the clusters filtering interactions.", fig.width=16, fig.height=16}
# Chord diagram of the total significant interactions from each cluster and all the rest.
out <- SCpubr::do_LigandReceptorPlot(liana_output = liana_output,
                                     top_interactions = 25,
                                     keep_source = c("0", "7"),
...
```{r, fig.cap = "SCpubr do_LigandReceptorPlot output Chord diagram with the total ligand-receptor interactions from each cluster and all the rest filtering interactions.", fig.width=16, fig.height=16}
# Chord diagram of the total ligand-receptor interactions from each cluster and all the rest.
out$chord_ligand_receptor
```
