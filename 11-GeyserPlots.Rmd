...
```{r, fig.cap = "SCpubr do_GeyserPlot regular use.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr do_GeyserPlot without ordering by the mean.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr do_GeyserPlot plotting a symmetrical scale.", fig.width=10, fig.height=10}
# Geyser plot with continuous color scale.
p1 <- SCpubr::do_GeyserPlot(sample = sample,
                            features = "UMAP_2",
                            scale_type = "continuous",
...
```{r, fig.cap = "SCpubr do_GeyserPlot plotting different groups.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr do_GeyserPlot splitting by groups.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr do_GeyserPlot rotating X axis labels.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr do_GeyserPlot adding a third variable.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr do_GeyserPlot adding a third variable and using split.by.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr do_GeyserPlot controlling the jittering.", fig.width=10, fig.height=30}
