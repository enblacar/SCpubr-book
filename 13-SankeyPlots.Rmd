...
```{r, fig.cap = "Basic Sankey and Alluvial plots.", fig.width=7, fig.height=14}
...
```{r, fig.cap = "Basic Sankey and Alluvial plots with more groups.", fig.width=7, fig.height=14}
...
```{r, fig.cap = "Basic Sankey and Alluvial plots with modified colors for the nodes.", fig.width=7, fig.height=14}
...
```{r, fig.cap = "Basic Sankey and Alluvial plots with modified width of the nodes.", fig.width=7, fig.height=14}
...
```{r, fig.cap = "Basic Sankey and Alluvial plots with modified label alignment.", fig.width=7, fig.height=14}
...
```{r, fig.cap = "Sankey plots with texts and labels.", fig.width=7, fig.height=14}
...
```{r, fig.cap = "Sankey plots with modified spaces between the nodes.", fig.width=7, fig.height=14}
...
```{r, fig.cap = "Sankey plots with modified default colors.", fig.width=7, fig.height=7}
# Modify default colors.
