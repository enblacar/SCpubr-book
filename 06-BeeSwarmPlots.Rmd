...
```{r, fig.cap = "Using continuous color scale in SCpubr::do_BeeSwarmPlot().", fig.width=21, fig.height=8}
...
```{r, fig.cap = "SCpubr, modifying default colors in a Bee Swarm plot", fig.width=7, fig.height=8}
