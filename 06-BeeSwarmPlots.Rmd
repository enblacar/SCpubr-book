...
```{r, fig.cap = "Distribution of enrichment scores and ranks.", fig.width=10, fig.height=5}
# Compute enrichment.
...
```{r, fig.cap = "Splitting the ranks by groups.", fig.width=10, fig.height=5}
...
```{r, fig.cap = "Plotting PCA embeddings with SCpubr::do_DimPlot()", fig.width=10, fig.height=5}
...
```{r, fig.cap = "SCpubr Bee Swarm plots with categorical variables.", fig.width=10, fig.height=10}
...
```{r, fig.cap = "SCpubr Bee Swarm plots with similar values.", fig.width=10, fig.height=5}
# Clusters to exclude.
...
```{r, fig.cap = "SCpubr Bee Swarm plots with almost identical values.", fig.width=10, fig.height=5}
# Clusters to exclude.
...
```{r, fig.cap = "Using continuous color scale in SCpubr::do_BeeSwarmPlot().", fig.width=15, fig.height=5}
...
```{r, fig.cap = "SCpubr, modifying default colors in a Bee Swarm plot", fig.width=5, fig.height=5}
...
```{r, fig.cap = "SCpubr::do_BeeSwarmPlot modifying viridis color maps.", fig.width=10, fig.height=16}
