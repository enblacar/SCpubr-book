...
`SCpubr::do_GroupedGOTermPlot()` will be available in the next CRAN release! (v1.1.0)
:::
...
This function might take a while to compute, specially for the **Biological Process** ontology. If you are running it interactively, conside passing `verbose = TRUE` to see the process.
:::
