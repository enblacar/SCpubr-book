...
```{r, fig.cap="SCpubr::do_VolcanoPlot with default parameters.", fig.width=7, fig.height=7}
...
```{r, fig.cap="SCpubr::do_VolcanoPlot modifying cutoffs.", fig.width=7, fig.height=7}
# Modify cutoffs.
p <- SCpubr::do_VolcanoPlot(sample = sample,
                            de_genes = de_genes,
                            pval_cutoff = 1e-15,
...
```{r, fig.cap="SCpubr::do_VolcanoPlot modifying the number of gene tags.", fig.width=7, fig.height=7}
