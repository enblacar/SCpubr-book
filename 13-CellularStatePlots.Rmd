...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 2 variables", fig.width=8, fig.height=8}
...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 2 variables symmetry enforced", fig.width=8, fig.height=8}
p <- SCpubr::do_CellularStatesPlot(sample = sample,
                                   gene_list = gene_set,
                                   x1 = "A",
                                   y1 = "B",
...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 3 variables", fig.width=8, fig.height=8}
p <- SCpubr::do_CellularStatesPlot(sample = sample,
                                   gene_list = gene_set,
                                   x1 = "A",
                                   y1 = "B",
...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 3 variables symmetry enforced", fig.width=8, fig.height=8}
p <- SCpubr::do_CellularStatesPlot(sample = sample,
                                   gene_list = gene_set,
                                   x1 = "A",
                                   y1 = "B",
...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 4 variables", fig.width=8, fig.height=8}
p <- SCpubr::do_CellularStatesPlot(sample = sample,
                                   gene_list = gene_set,
                                   x1 = "A",
                                   y1 = "C",
...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 4 variables symmetry enforced", fig.width=8, fig.height=8}
p <- SCpubr::do_CellularStatesPlot(sample = sample,
                                   gene_list = gene_set,
                                   x1 = "A",
                                   y1 = "C",
...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 4 variables symmetry enforced querying for features", fig.width=24, fig.height=8}
...
```{r, fig.cap="SCpubr::do_CellularStatesPlot, 4 variables symmetry enforced querying for enrichment scores of the original list of genes", fig.width=16, fig.height=8}
out <- SCpubr::do_CellularStatesPlot(sample = sample,
                                     gene_list = gene_set,
                                     x1 = "A",
                                     y1 = "C",
