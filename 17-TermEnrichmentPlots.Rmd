...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot default use case.", fig.width=18, fig.height=18}
# Default plot.
...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot with increased terms.", fig.width=18, fig.height=18}
...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot with reduced term length.", fig.width=18, fig.height=36}
...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot with modified fontsize", fig.width=18, fig.height=36}
