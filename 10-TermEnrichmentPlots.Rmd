...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot use case.", fig.width=25, fig.height=20}
...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot with increased terms.", fig.width=15, fig.height=20}
# Genes related to breast cancer.
genes <- c("ABCB1", "ABCG2", "AHR", "AKT1", "AR")
p <- SCpubr::do_TermEnrichmentPlot(genes = genes,
...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot with reduced term length.", fig.width=30, fig.height=20}
# Genes related to breast cancer.
genes <- c("ABCB1", "ABCG2", "AHR", "AKT1", "AR")
...
```{r, fig.cap="SCpubr do_TermEnrichmentPlot with modified colors", fig.width=15, fig.height=7.5}
# Genes related to breast cancer.
genes <- c("ABCB1", "ABCG2", "AHR", "AKT1", "AR")
p <- SCpubr::do_TermEnrichmentPlot(genes = genes,
                                   dbs_use = "GO_Biological_Process_2021",
