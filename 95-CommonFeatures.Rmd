...
p
```
```{r, fig.width=7, fig.height=7, fig.cap="SCpubr::do_CorrelationPlot with normal colors"}
...
```{r, fig.width=14, fig.height=7, fig.cap = "Plotting marginal plots"}
genes <- list("A" = Seurat::VariableFeatures(sample)[1:5],
              "B" = Seurat::VariableFeatures(sample)[6:10],
              "C" = Seurat::VariableFeatures(sample)[11:15],
              "D" = Seurat::VariableFeatures(sample)[16:20])
...
```{r, fig.width=14, fig.height=7, fig.cap = "Plotting marginal plots without grouping"}
genes <- list("A" = Seurat::VariableFeatures(sample)[1:5],
              "B" = Seurat::VariableFeatures(sample)[6:10],
              "C" = Seurat::VariableFeatures(sample)[11:15],
              "D" = Seurat::VariableFeatures(sample)[16:20])
...
```{r, fig.width=14, fig.height=7, fig.cap = "Plotting marginal plots with modified ratio"}
genes <- list("A" = Seurat::VariableFeatures(sample)[1:5],
              "B" = Seurat::VariableFeatures(sample)[6:10],
              "C" = Seurat::VariableFeatures(sample)[11:15],
              "D" = Seurat::VariableFeatures(sample)[16:20])
...
```{r, fig.width=14, fig.height=7, fig.cap = "Plotting marginal plots with modified distributions - histogram"}
genes <- list("A" = Seurat::VariableFeatures(sample)[1:5],
              "B" = Seurat::VariableFeatures(sample)[6:10],
              "C" = Seurat::VariableFeatures(sample)[11:15],
              "D" = Seurat::VariableFeatures(sample)[16:20])
...
```{r, fig.width=14, fig.height=7, fig.cap = "Plotting marginal plots with modified distributions - violin"}
genes <- list("A" = Seurat::VariableFeatures(sample)[1:5],
              "B" = Seurat::VariableFeatures(sample)[6:10],
              "C" = Seurat::VariableFeatures(sample)[11:15],
              "D" = Seurat::VariableFeatures(sample)[16:20])
...
```{r, fig.width=14, fig.height=7, fig.cap = "Plotting marginal plots with modified distributions - boxplot"}
genes <- list("A" = Seurat::VariableFeatures(sample)[1:5],
              "B" = Seurat::VariableFeatures(sample)[6:10],
              "C" = Seurat::VariableFeatures(sample)[11:15],
              "D" = Seurat::VariableFeatures(sample)[16:20])
...
```{r, fig.width=14, fig.height=7, fig.cap = "Plotting marginal plots with modified distributions - densigram"}
genes <- list("A" = Seurat::VariableFeatures(sample)[1:5],
              "B" = Seurat::VariableFeatures(sample)[6:10],
              "C" = Seurat::VariableFeatures(sample)[11:15],
              "D" = Seurat::VariableFeatures(sample)[16:20])
...
```{r, fig.width=21, fig.height=7, fig.cap = "SCpubr::do_DimPlot cell borders"}
p1 <- SCpubr::do_DimPlot(sample = sample)
...
p
```
```{r, fig.width=21, fig.height=7, fig.cap = "SCpubr::do_FeaturePlot cell borders"}
p1 <- SCpubr::do_FeaturePlot(sample = sample,
                             features = "CD14")
...
p
```
```{r, fig.width=21, fig.height=7, fig.cap = "SCpubr::do_NebulosaPlot cell borders"}
p1 <- SCpubr::do_NebulosaPlot(sample = sample,
                              features = "CD14")
...
```{r, fig.width=21, fig.height=7, fig.cap = "SCpubr::do_BeeSwarmPlot cell borders"}
p1 <- SCpubr::do_BeeSwarmPlot(sample = sample,
                              feature_to_rank = "PC_1",
                              group.by = "seurat_clusters")
