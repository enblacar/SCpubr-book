...
```{r, fig.cap = "Seurat FeaturePlot split by clusters.", fig.width=21, fig.height=8}
...
```{r, fig.cap = "SCpubr FeaturePlot split by clusters.", fig.width=21, fig.height=8}
...
```{r, fig.cap = "SCpubr FeaturePlot split by clusters using multiple features.", fig.width=63, fig.height=8}
...
```{r, fig.cap = "SCpubr FeaturePlot using a two-end continuous scale.", fig.width=14, fig.height=8}
