...
```{r, fig.cap = "SCpubr FeaturePlot, with minor modifications", fig.width=8, fig.height=7}
...
```{r, fig.cap = "SCpubr FeaturePlot, with 4 features and 2 columns", fig.width=8, fig.height=7}
...
```{r, fig.cap = "SCpubr FeaturePlot, with individual modified titles", fig.width=16, fig.height=16}
...
```{r, fig.cap = "SCpubr FeaturePlot, removing cells from clusters 2, 5 and 8", fig.width=8, fig.height=7}
...
```{r, fig.cap = "SCpubr FeaturePlot, masking cells from clusters 2, 5 and 8", fig.width=8, fig.height=7}
cells.plot <- colnames(sample[, !(sample$seurat_clusters %in% c("2", "5", "8"))])
p <- SCpubr::do_FeaturePlot(sample = sample, 
...
```{r, fig.cap = "SCpubr FeaturePlot, masking cells from clusters 2, 5 and 8 using idents.highlight", fig.width=8, fig.height=7}
...
```{r, fig.cap = "Seurat FeaturePlot split by clusters.", fig.width=22, fig.height=7}
# Group clusters.
...
```{r, fig.cap = "SCpubr FeaturePlot split by clusters.", fig.width=24, fig.height=7}
p <- SCpubr::do_FeaturePlot(sample = sample, 
                            features = "LYN", 
                            split.by = "new_clusters")
p
...
```{r, fig.cap = "SCpubr FeaturePlot split by clusters using multiple features.", fig.width=24, fig.height=21}
...
```{r, fig.cap = "SCpubr FeaturePlot split by clusters using multiple features and selected identities.", fig.width=16, fig.height=21}
p <- SCpubr::do_FeaturePlot(sample, 
                            features = c("LYN", "nCount_RNA", "PC_1"), 
