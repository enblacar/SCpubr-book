...
```{r, fig.cap = "SCpubr FeaturePlot split by clusters using multiple features.", fig.width=14, fig.height=12}
...
```{r, fig.cap = "SCpubr FeaturePlot split by clusters using multiple features and selected identities.", fig.width=8, fig.height=12}
p <- SCpubr::do_FeaturePlot(sample, 
                            features = c("LYN", "nCount_RNA", "PC_1"), 
