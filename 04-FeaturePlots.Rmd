...
```{r, fig.cap = "SCpubr Feature with PCA embedding showing axes titles.", fig.width=16, fig.height=7}
...
```{r, fig.cap = "SCpubr FeaturePlot, with 4 features and 2 columns", fig.width=16, fig.height=14}
