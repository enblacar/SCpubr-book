...
```{r, fig.cap="SCpubr DotPlot using multiple genes", fig.width=18, fig.height=8}
...
```{r, fig.cap="SCpubr DotPlot using multiple genes and clustering the identities", fig.width=18, fig.height=14}
genes <- list("Naive CD4+ T" = c("IL7R", "CCR7"),
              "CD14+ Mono" = c("CD14", "LYZ"),
              "Memory CD4+" = c("S100A4"),
              "B" = c("MS4A1"),
