...
<div class="figure" style="text-align: center">
<img src="04-FeaturePlots_files/figure-html/unnamed-chunk-12-1.png" alt="SCpubr FeaturePlot using min.cutoff and max.cutoff." width="100%" height="100%" />
<p class="caption">(\#fig:unnamed-chunk-12)SCpubr FeaturePlot using min.cutoff and max.cutoff.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="04-FeaturePlots_files/figure-html/unnamed-chunk-13-1.png" alt="SCpubr FeaturePlot using a two-end continuous scale." width="100%" height="100%" />
<p class="caption">(\#fig:unnamed-chunk-13)SCpubr FeaturePlot using a two-end continuous scale.</p>
</div>
