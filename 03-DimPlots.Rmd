...
```{r, fig.cap = "SCpubr DimPlot vs Seurat DimPlot.", fig.width=16, fig.height=7}
# Seurat's DimPlot.
...
```{r, fig.cap = "SCpubr DimPlot with legend to the left.", fig.width=16, fig.height=7}
...
```{r, fig.cap = "Seurat DimPlot with labels on top of the clusters and a different color.", fig.width=7, fig.height=7}
...
```{r, fig.cap = "Seurat DimPlot without legend.", fig.width=7, fig.height=7}
...
```{r, fig.cap = "Highlighting cells, comparison between Seurat and SCpubr.", fig.width=16, fig.height=7}
...
```{r, fig.cap = "SCpubr DimPlot highlighting cells and changing default colors.", fig.width=8, fig.height=7}
...
```{r, fig.cap = "SCpubr DimPlot highlighting cells testing combinations of cells.highlight and idents.highlight.", fig.width=24, fig.height=7}
